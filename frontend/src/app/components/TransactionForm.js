              ...
              {!initialData && (
                <div className="flex gap-4 items-end">
                  ...
                  <div className="flex-1">
                    ...
                    <div
                      className={`flex items-center gap-2 p-1.5 rounded-2xl border transition-all h-[46px] ${numInstallments > 1 && !isRecurring ? 'bg-blue-600 border-blue-600' : 'bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700'}`}
                    >
                      <input
                        type="number"
                        min="1"
              ...
              <div className="space-y-3 pt-4">
                ...
                {initialData && (
                  <button
                    ...
                    disabled={isSubmitting || isDeleting}
                    className="w-full flex items-center justify-center gap-2 text-red-500 font-bold py-2 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors disabled:opacity-50"
                  >
                    {isDeleting ? (
                      <Loading />
                    ) : (
